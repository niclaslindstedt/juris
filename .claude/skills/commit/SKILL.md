...
Scopes are lowercase, comma-separated if multiple: `feat(riksdagen,index): ...`
...
- If the branch touches multiple scopes, use comma-separated scopes: `feat(riksdagen,index): ...`
